    ...
    def post(self, request):
        ...
        if serializer.is_valid():
            ...
            try:
                ...
                artist_new.age = age
                artist_new.albums = f'http://127.0.0.1:8000/artists/{artist_new.id}/albums'
                artist_new.tracks = f'http://127.0.0.1:8000/artists/{artist_new.id}/tracks'
                artist_new.self = f'http://127.0.0.1:8000/artists/{artist_new.id}'
                artist_new.save()
...
class ArtistIDView(APIView):
    ...
    def get(self, request, pk):
        ...
        aux_dict["self"] = f'http://127.0.0.1:8000/artists/{artist_data.id}'
...
class AlbumsArtistView(APIView):
    ...
    def get(self, request, pk):
        ...
        for album in album_data:
            ...
            aux_dict["self"] = f'http://127.0.0.1:8000/albums/{album.id}'
    ...
    def post(self, request, pk):
        ...
        if serializer.is_valid():
            ...
            try:
                ...
                album_new.tracks = f'http://127.0.0.1:8000/albums/{album_new.id}/tracks'
                album_new.artist = f'http://127.0.0.1:8000/artists/{artist.id}'
                album_new.self = f'http://127.0.0.1:8000/albums/{album_new.id}'
                album_new.save()
                return Response(serializer.data, status=status.HTTP_201_CREATED)
...
class AlbumIDView(APIView):
    ...
    def get(self, request, pk):
        ...
        aux_dict["self"] = f'http://127.0.0.1:8000/albums/{album_data.id}'
...
class TracksAlbumView(APIView):
    ...
    def get(self, request, pk):
        ...
        for track in track_data:
            ...
            aux_dict["self"] = f'http://127.0.0.1:8000/tracks/{track.id}'
    ...
    def post(self, request, pk):
        ...
        if serializer.is_valid():
            ...
            try:
                ...
                track_new.artist = f'http://127.0.0.1:8000/artists/{aux_id}'
                track_new.album = f'http://127.0.0.1:8000/albums/{album.id}'
                track_new.self = f'http://127.0.0.1:8000/tracks/{track_new.id}'
                track_new.save()
                #aux_dict = dict()
                #aux_dict["id"] = coded_id[:22]
                #aux_dict["album_id"] = album.id
                #aux_dict["name"] = name
                #aux_dict["duration"] = duration
                #aux_dict["times_played"] = track_new.times_played
                #aux_dict["artist"] = f'http://127.0.0.1:8000/artists/{aux_id}'
                #aux_dict["album"] = f'http://127.0.0.1:8000/albums/{album.id}'
                #aux_dict["self"] = f'http://127.0.0.1:8000/tracks/{track_new.id}'
                return Response(serializer.data, status=status.HTTP_201_CREATED)
    ...
    def get(self, request, pk):
        ...
        for element in albums:
            ...
            for track in track_data:
                ...
                aux_dict_2["self"] = f'http://127.0.0.1:8000/tracks/{track.id}'
...
class TrackIDView(APIView):
    ...
    def get(self, request, pk):
        ...
        aux_dict["self"] = f'http://127.0.0.1:8000/tracks/{track_data.id}'
        return Response(aux_dict)
